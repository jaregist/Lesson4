...
export default function EditProfile({ match }) {
  ...
  const clickSubmit = () => {
    ...
    values.passoword && userData.append('passoword', values.passoword)  //passoword?? check back if doesnt work correctly
  ...
  const handleChange = name => event => {
    const value = name === 'photo'
      ...
      : event.target.value
    setValues({...values, [name]: value}) //event.targets.value
  }
